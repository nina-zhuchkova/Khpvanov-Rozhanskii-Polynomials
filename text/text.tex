...
\end{tcolorbox}
$\triangleleft$
From the acyclicity of the vertical complexes we obtain that $C_{n, 0} \overset{d^v_{n, 0}}{\cong} C_{n, 1}$. Hence, in view of the bicomplex anticommutativity $d^v_{n+1, m} \circ d^h_{n, m} = d^h_{n, m+1} \circ d^v_{n, m}$, we conclude that the bicomplex can be redrawn in the following way:
